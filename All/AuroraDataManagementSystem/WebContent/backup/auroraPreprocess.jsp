			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<div class="widget_contents noPadding">
						...
						<div class="line_grid">
							<div class="g_3"><span class="label">预处理算法&参数</span></div>
							<div class="g_2">
								<select class="simple_form">
									<option value="LBP" selected="selected" />去云
									<option value="DSIFT" />元数据提取
								</select>
							</div>
							<div class="g_4">
						...
						<div class="line_grid">
							...
							<div class="g_9">
								<a href="auroraExtraction.jsp"><input type="submit" value="下一步" class="simple_buttons" /></a>
							</div>
						</div>	
