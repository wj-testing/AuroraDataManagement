...
//	            				int point =value.getLength()-524289;
							int point = 0;
	            			    for(int i=0;i<512;i++)
	            			    	for(int j=0;j<512;j++)
	            			    	{
										System.out.println("value:"+value.getLength());
										System.out.println(value);
										System.out.println("b:"+b.length);
										System.out.println(b);
//	            			    		result[i][j]=getByte(b[point+1],b[point+2]);
										System.out.println("result"+getByte(b[point+1],b[point+2]));
	            			    		point=point+2;
	            			    	}
