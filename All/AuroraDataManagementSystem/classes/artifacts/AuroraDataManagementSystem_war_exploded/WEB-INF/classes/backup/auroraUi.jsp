...
<!-- Change Pattern -->
	...
	<header class="main_header">
		<div class="wrapper">
			<div class="logo">"src/aurora/TimeQueryServlet.java"
	...
	<div class="wrapper contents_wrapper">
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<form name="labelQueryForm" method="POST" action="labelquery">
					<div class="g_12">
						<div class="widget_contents noPadding">
							...
							<div class="line_grid">
								...
								<div class="g_9">
									<input class="simple_field" type="text" name="endTime"/>
								</div>
							</div>
							<div class="line_grid">
								<div class="g_3"><span class="label">时间</span></div>
								<div class="g_9">
			    ...
			    <div class="g_12">
					...
					<div class="widget_contents noPadding">
						<div class="line_grid">
							<div class="g_2"><span class="label">N20031221G030001</span></div>
							<div class="g_8">
								<img src="auroraData\N20031221G030001.jpg" alt="">
							</div>
							<div class="g_2">
								<div class="line_grid">
									<input type="radio" class="simple_form" name="radio_name" />Mularc
								</div>
								<div class="line_grid">
									<input type="radio" class="simple_form" name="radio_name" />Drapery-corona
								</div>
								<div class="line_grid">
									<input type="radio" class="simple_form" name="radio_name" />Radial-corona
								</div>
								<div class="line_grid">
									<input type="radio" class="simple_form" name="radio_name" />Hot-spot
								</div>
								<div class="line_grid">
									<input type="submit" value="保存" class="simple_buttons" />
								</div>		
							</div>
						</div>
					</div>
			    ...
			    <div class="g_12">
					...
					<div class="widget_contents noPadding">
						<% 
							List<String> path = (ArrayList)request.getAttribute("path");
						%> 
						<%for(String p:path){ %>
						<form name="labelForm" method="POST" action="label">
							<div class="line_grid">
								<input type="hidden" name="time" value=<%=p.substring(6,22) %>/>
								<div class="g_2"><span class="label"><%=p.substring(6,22) %></span></div>
								<div class="g_8">
									<img src=<%=p %> alt="">
								</div>
								<div class="g_2">
									<div class="line_grid">
										<input type="radio" class="simple_form" name="type" value="1"/>Mularc
									</div>
									<div class="line_grid">
										<input type="radio" class="simple_form" name="type" value="2"/>Drapery-corona
									</div>
									<div class="line_grid">
										<input type="radio" class="simple_form" name="type" value="3"/>Radial-corona
									</div>
									<div class="line_grid">
										<input type="radio" class="simple_form" name="type" value="4"/>Hot-spot
									</div>
									<div class="line_grid">
										<input type="submit" value="保存" class="simple_buttons" />
									</div>		
